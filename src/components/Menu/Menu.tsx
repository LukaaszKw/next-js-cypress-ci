  ...
  return (
    <div
                                            ...
                                            <div className="ml-3 h-7 flex justify-end items-center">
                                                <button type="button" data-cy-id="buttonClose"
                                            ...
                                            <div className="flex mx-auto mt-3 w-100 ">
                                                <a href=""> <button
                                                        className="p-2 shadow-lg rounded-2xl tr-300 w-100 font-medium  bg-green-500 rounded-md hover:bg-green-600 text-gray-50">Mejorar
                                                        membresía</button></a>
                                            </div>
                                        </div>
  );
