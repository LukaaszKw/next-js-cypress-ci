...
export default function HorizontalCard() {
  ...
  return (
    <div className="horizontal-card flex flex-col justify-center items-center h-[100vh]">
        ...
        <div className='ml-auto'>
          <div className='relative flex'>
            <div className='flex'>
              <button className='linear flex items-center justify-center rounded-lg bg-lightPrimary p-2 text-xl font-bold text-brand-500 transition duration-200 hover:cursor-pointer hover:bg-gray-100 dark:bg-navy-700 dark:text-white dark:hover:bg-white/20 dark:active:bg-white/10'>
                <svg
                  stroke='currentColor'
                  fill='currentColor'
                  stroke-width='0'
        ...
        <div className='flex flex-col'>
          ...
          <div className='mt-2 flex h-3 w-full items-center rounded-full bg-lightPrimary dark:!bg-navy-700'>
            <span className='h-full w-1/2 rounded-full bg-brand-500'></span>
          </div>
        </div>
      </div>
    </div>
